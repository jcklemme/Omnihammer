...
Model must be in base contact at the start of the Shooting Phase.
The model's unit must pass a Leadership test. If failed, the gun is not crewed this turn.
If passed, the model becomes the gun's crew. The gun may be fired this turn.
Firing a Crewed Gun:
If the unit crewing the Abandoned Artillery has the same datasheet as original crew: fires at the crewing model's normal BS.
...
Self-propelled artillery (Basilisk, Medusa, etc.) is NOT affected by these rules. Self-propelled guns are vehicles and follow vehicle destruction rules and do not have the (Artillery) sub-type.
...
14
13
Concrete, Stone, heavy metal
12
11
Wooden structures, corrugated metal, sheds
10
9
